...
<body>
	...
	<form class="form-box" runat="server">
		...
		<div style="text-align: left;">
			...
			<div>
				<asp:Login ID="Login" runat="server" OnAuthenticate="Login_Authenticate" Width="574px">
                    <LayoutTemplate>
                        <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                        <tr><asp:Label ID="UserNameLabel" runat="server" AssociatedControlID="UserName">Username</asp:Label>
                        </tr>
                        <tr width="100%"><asp:TextBox ID="UserName" runat="server" class="input-field" placeholder="********"></asp:TextBox>
                        ...
                        <tr><asp:Label ID="PasswordLabel" runat="server" AssociatedControlID="Password">Password</asp:Label>
                        </tr>
                        ...
                        <tr><td align="right"><asp:Button ID="LoginButton" runat="server" class="submit-btn" CommandName="Login" Text="Log In" ValidationGroup="Login" />
